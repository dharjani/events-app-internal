...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'cool location' },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'cooler location' }
    ]
};
